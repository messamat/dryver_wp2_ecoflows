...
fungi_sed <- fread("C:/Users/vilmi/Desktop/DRYVERR/2024/Data/fungi_dna_sediment_removed_zero_rows_and_columns.csv")
fungi_sed[1:10, 1:10]

levels(factor(fungi_sed$Country))

#### Croatia ####
com <- fungi_sed[Country == "Croatia"] 

# tot <- rowSums(com[,6:3063]) ### MUOKATTAVA !!!!
# com <- com[tot > 0, ]
...
end_time - start_time
# Saving
sink("C:/Users/vilmi/Desktop/DRYVERR/2024/Results/CRO_sediment_fungi_null_models_999perm.txt") ### MUOKATTAVA !!!!
paste("-----")
paste("jaccard, null model")
output_Croatia
sink()
#### Czech ####
com <- fungi_sed[Country == "Czech"] ### MUOKATTAVA !!!
...
end_time - start_time
# Saving
sink("C:/Users/vilmi/Desktop/DRYVERR/2024/Results/CZE_sediment_fungi_null_models_999perm.txt") ### MUOKATTAVA !!!
paste("-----")
paste("jaccard, null model")
output_Czech
sink()
...
#### Finland ####
com <- fungi_sed[Country == "Finland"]  ### MUOKATTAVA !!!
...
end_time - start_time
# Saving
sink("C:/Users/vilmi/Desktop/DRYVERR/2024/Results/FIN_sediment_fungi_null_models_999perm.txt") ### MUOKATTAVA !!!
paste("-----")
paste("jaccard, null model")
output_Finland
sink()
...
#### France ####
com <- fungi_sed[Country == "France"]  ### MUOKATTAVA !!!
...
end_time - start_time
# Saving
sink("C:/Users/vilmi/Desktop/DRYVERR/2024/Results/FRA_sediment_fungi_null_models_999perm.txt") ### MUOKATTAVA !!!
paste("-----")
paste("jaccard, null model")
output_France
sink()
...
#### Hungary ####
com <- fungi_sed[Country == "Hungary"]  ### MUOKATTAVA !!!
...
end_time - start_time
# Saving
sink("C:/Users/vilmi/Desktop/DRYVERR/2024/Results/HUN_sediment_fungi_null_models_999perm.txt") ### MUOKATTAVA !!!
paste("-----")
paste("jaccard, null model")
output_Hungary
sink()
...
#### Spain ####
com <- fungi_sed[Country == "Spain"] ### MUOKATTAVA !!!
...
end_time - start_time
# Saving
sink("C:/Users/vilmi/Desktop/DRYVERR/2024/Results/SPA_sediment_fungi_null_models_999perm.txt") ### MUOKATTAVA !!!
paste("-----")
paste("jaccard, null model")
output_Spain
sink()
...
res$Organism <- "Sediment_fungi" #### MUOKATTAVA !!! 

save(res, file = "C:/Users/vilmi/Desktop/DRYVERR/2024/Results/Sediment_fungi_jaccard_oecosimu_999p.Rdata") #### MUOKATTAVA !!! 
# Next : save R workspace
save.image(file = "C:/Users/vilmi/Desktop/DRYVERR/2024/Results/Sediment_fungi_jaccard_oecosimu_999p_workspace.Rdata") #### MUOKATTAVA !!! 
