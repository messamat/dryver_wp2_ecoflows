...
mac <- fread("C:/Users/vilmi/Desktop/DRYVERR/2024/Data/DRYvER_MIV_data_genus_reduced_taxa_removed_pools_for_traits_flying.csv")
mac[1:10, 1:10]
...
end_time - start_time
# Saving
sink("C:/Users/vilmi/Desktop/DRYVERR/2024/Results/CRO_flying_mac_null_models_999perm.txt") ### MUOKATTAVA !!!!
paste("-----")
...
end_time - start_time
# Saving
sink("C:/Users/vilmi/Desktop/DRYVERR/2024/Results/CZE_flying_mac_null_models_999perm.txt") ### MUOKATTAVA !!!
paste("-----")
paste("jaccard, null model")
output_Czech
sink()
...
end_time - start_time
# Saving
sink("C:/Users/vilmi/Desktop/DRYVERR/2024/Results/FIN_flying_mac_null_models_999perm.txt") ### MUOKATTAVA !!!
paste("-----")
paste("jaccard, null model")
output_Finland
sink()
...
end_time - start_time
# Saving
sink("C:/Users/vilmi/Desktop/DRYVERR/2024/Results/FRA_flying_mac_null_models_999perm.txt") ### MUOKATTAVA !!!
paste("-----")
paste("jaccard, null model")
output_France
sink()
...
end_time - start_time
# Saving
sink("C:/Users/vilmi/Desktop/DRYVERR/2024/Results/HUN_flying_mac_null_models_999perm.txt") ### MUOKATTAVA !!!
paste("-----")
paste("jaccard, null model")
output_Hungary
sink()
...
end_time - start_time
# Saving
sink("C:/Users/vilmi/Desktop/DRYVERR/2024/Results/SPA_flying_mac_null_models_999perm.txt") ### MUOKATTAVA !!!
paste("-----")
paste("jaccard, null model")
output_Spain
sink()
...
res$Organism <- "Flying_macroinvertebrates" #### MUOKATTAVA !!! 

save(res, file = "C:/Users/vilmi/Desktop/DRYVERR/2024/Results/Mac_flying_jaccard_oecosimu_999p.Rdata") #### MUOKATTAVA !!! 
write.csv(res, file = "C:/Users/vilmi/Desktop/DRYVERR/2024/Results/Mac_flying_jaccard_oecosimu_999p.csv") #### MUOKATTAVA !!! 
# Next : save R workspace
save.image(file = "C:/Users/vilmi/Desktop/DRYVERR/2024/Results/Mac_flying_jaccard_oecosimu_999p_workspace.Rdata") #### MUOKATTAVA !!! 
